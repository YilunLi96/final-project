...
# 2, start filling in courses following that above order
	...
	# 5, (maybe don't do it first, then add it, then compare speed? maybe too extra?)if the requirement is fulfilled, delete all courses that only satisfies this one requirement from course catalog ("filtering")
# 6 repeat until full